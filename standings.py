...
def get_standings(fromFile, toFile, date=None, include_prediction=False, predicted_date_so_far=None,
                ranking_summary_file=None):
    if date:
...
def get_all_standings(fromYear, toYear, fromFileFolderPath, toFileFolderPath):
    for year in range(fromYear, toYear + 1):
        ...
        get_standings(fromFile, toFile, '{}-12-31'.format(str(year + 1)), include_prediction=False)

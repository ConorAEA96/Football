...
from clean_data import clean_everything, combine_games, get_match_results_against, remove_goal_scores, copy_csv, \
...
def magic(should_train=True, data_year_available_from=1993, data_year_collect_from=2006):
    ...
    RAW_DATA_FILE_PATH = os.path.join(DATA_PATH, 'raw_data')
    ...
    get_all_standings(data_year_available_from, current_year, RAW_CLEANED_DATA_FILE_PATH, STANDINGS_PATH)
    ...
    clean_everything(RAW_DATA_FILE_PATH, RAW_CLEANED_DATA_FILE_PATH, columns, data_year_available_from, current_year)
    ...
    combine_games(CLEANED_DATA_FILE_PATH, FINAL_FILE, data_year_collect_from, current_year)
